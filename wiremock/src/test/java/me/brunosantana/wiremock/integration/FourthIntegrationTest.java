...
public class FourthIntegrationTest {
    ...
    public void startServer() throws IOException, URISyntaxException {
        ...
        wireMockServer.stubFor(get(urlPathMatching("/albums/[0-9]+/photos"))
                .inScenario("photos scenario")
                .whenScenarioStateIs(STARTED)
                .willReturn(aResponse()
                        .withStatus(200)
                        .withHeader("Content-Type", "application/json; charset=utf-8")
                        .withBody(fileReaderUtil.read("jsonplaceholder-response.json")))
                .willSetStateTo("stub 2"));

        wireMockServer.stubFor(get(urlPathMatching("/albums/[0-9]+/photos"))
                .inScenario("photos scenario")
                .whenScenarioStateIs("stub 2")
                .willReturn(aResponse()
                        .withStatus(200)
                        .withHeader("Content-Type", "application/json; charset=utf-8")
                        .withBody(fileReaderUtil.read("jsonplaceholder-response-2.json"))));
